		...
		<div class="header_menu">
				...
				<c:choose>
					...
					<c:otherwise>
						<ul>
							...
							<li><a href="http://localhost:9000/mycgv_jsp/notice_list.do">공지사항</a></li>
							<li><a href="http://localhost:9000/mycgv_jsp/board_list.do">게시판</a></li>
							<c:if test="${sessionScope.svo.name == '관리자'}">
								<li><a href="http://localhost:9000/mycgv_jsp/admin_index.do">ADMIN</a></li>
							</c:if>
						</ul>
					</c:otherwise>
			...
			<div>
				<a href="http://localhost:9000/mycgv_jsp/index.do">
					<img src="http://localhost:9000/mycgv_jsp/resources/images/h1_cgv.png">
				</a>
				<div>
					<img src="http://localhost:9000/mycgv_jsp/resources/images/h2_cultureplex.png" >
					<nav class="nav2">
						<ul>
							<li><a href="#">영화</a></li>
							<li><a href="#">예매</a></li>
